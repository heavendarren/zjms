 ...
 * 修改/完善：YouAreStupid
 */
public class DatePickerButton extends JButton implements ActionListener{
    ...
    public DatePickerButton(JTextField date){
        curDate=date;
    ...
    private void initOriginalText(String dateString) {
            ...
            this.curDate.setText(dateString);
        }
...
//        mainFrame.setVisible(false);
            ...
            return new Point((int) (lx / 2) - 400, (int) (ly / 2) - 300);
            //model =true  模态窗口，窗口不关闭，线程阻塞
//            dialog.setLocation();//设定窗口出现位置
